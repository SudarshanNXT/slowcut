    ...
    return (
        <>
            ...
            <div className='hidden md:flex items-center justify-center border border-gray-500 rounded-md py-2 text-gray-400 font-semibold'>
                ...
                <a href={`/${username}/network`} className={`px-2 ${location.pathname === `/${username}/network` ? 'border-b-2 border-b-hover text-white' : ''} hover:text-white`}>Network</a>
            </div>
            ...
            <div className='md:hidden flex justify-center'>
                ...
                >
                    ...
                    <option value={`/${username}/network`}>Network</option>
                </select>
            </div>
        </>
    )
